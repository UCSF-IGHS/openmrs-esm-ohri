...
import { covidSARS_TestResult } from '../../constants';
...
const CovidAssessments: React.FC<CovidOverviewListProps> = ({ patientUuid }) => {
  // const rowCount = 5;
  ...
  //           observation => observation.concept.name.uuid === covidSARS_TestResult,
  //         );
  ...
  //   const headerTitle = t('covidLabResults', 'Assessment 2');
  //   const displayText = t('covidLabResults', 'Assessment ');
...
export default CovidAssessments;
