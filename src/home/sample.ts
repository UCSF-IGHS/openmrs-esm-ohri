...
const Sample: OhriForm = {
  ...
  pages: [
          ...
          questions: [
            {
              ...
              questionOptions: {
                ...
                answers: [{ label: 'yes', concept: '1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' }, { label: 'no' }],
              },
            ...
            },
            {
              ...
              questionOptions: {
                ...
                conceptMappings: [
                  { type: 'PIH', value: '2169' },
                  { type: 'SNOMED-MVP', value: '1594271000105002' },
                  { type: 'org.openmrs.module.mdrtb', value: 'RESULT OF HIV TEST' },
                  { type: 'SNOMED-CT', value: '31676001' },
                ],
                answers: [
                  {
                    ...
                    label: 'Negative',
                    conceptMappings: [
                      { type: 'AMPATH', value: '664' },
                      { type: 'SNOMED-CT', value: '260385009' },
                      { type: 'PIH', value: '664' },
                      { type: 'org.openmrs.module.mdrtb', value: 'NEGATIVE' },
                      { type: 'AMPATH', value: '665' },
                    ],
                  },
                  {
                    ...
                    label: 'Indeterminate',
                    conceptMappings: [
                      { type: 'AMPATH', value: '1138' },
                      { type: 'SNOMED-CT', value: '82334004' },
                    ],
                  },
                ],
              },
            ...
            },
            {
              ...
              type: 'obs',
              questionOptions: { rendering: 'date', concept: '164400AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', weeksList: '' },
              id: 'lastHIVTestDate',
            },
          ],
        },
          ...
          questions: [
            {
              ...
              questionOptions: {
                ...
                conceptMappings: [
                  { type: 'SNOMED-MVP', value: '14361000105003' },
                  { type: 'AMPATH', value: '2313' },
                  { type: 'SNOMED-CT', value: '278977008' },
                  { type: 'PIH', value: '3082' },
                ],
                answers: [
                  {
            ...
            },
            {
              ...
              questionOptions: {
                ...
                answers: [
                  { concept: '63ea75cb-205f-4e7b-9ede-5f9b8a4dda9f', label: 'Migrant Workers', conceptMappings: [] },
                  { concept: 'b282bb08-62a7-42c2-9bea-8751c267d13e', label: 'Uniformed Forces', conceptMappings: [] },
                  {
                  ...
                  { concept: 'def00c73-f6d5-42fb-bcec-0b192b5be22d', label: 'Fisher Folk', conceptMappings: [] },
                  { concept: '8da9bf92-22f6-40be-b468-1ad08de7d457', label: 'Prisoners', conceptMappings: [] },
                  { concept: 'dc1058ea-4edd-4780-aeaa-a474f7f3a437', label: 'Refugees', conceptMappings: [] },
                  {
                    concept: '160578AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
                    label: 'Male who has sex with men',
                    conceptMappings: [{ type: 'SNOMED-CT', value: '266974005' }],
                  },
                  {
                    concept: '160579AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
                    label: 'Sex worker',
                    conceptMappings: [{ type: 'SNOMED-CT', value: '53713009' }],
                  },
                  {
          ...
          questions: [
              ...
              questionOptions: {
                ...
                answers: [
                  ...
                  },
                  {
                    ...
                    conceptMappings: [
                      { type: 'PIH', value: '1651' },
                      { type: 'AMPATH', value: '1965' },
                      { type: 'SNOMED-CT', value: '33022008' },
                    ],
                  },
                  {
                    ...
                    label: 'Other',
                    conceptMappings: [
                      { type: 'PIH-Malawi', value: '6408' },
                      { type: 'org.openmrs.module.mdrtb', value: 'OTHER' },
                      { type: 'SNOMED-MVP', value: '56221000105001' },
                      { type: 'PIH', value: '5622' },
                      { type: 'AMPATH', value: '5622' },
                      { type: 'SNOMED-CT', value: '74964007' },
                    ],
                  },
                ],
              },
              ...
              questionOptions: {
                ...
                answers: [
                  ...
                  },
                  {
                    ...
                    conceptMappings: [{ type: 'SNOMED-NP', value: '270430005' }],
                  },
                ],
              },
              id: 'his-approach',
            },
            {
              ...
              questionOptions: {
                ...
                answers: [
                  ...
                  { concept: 'a6ad599d-2bc4-47b7-81fe-a38e88867c1d', label: 'Self Initiative', conceptMappings: [] },
                  {
            ...
            },
            {
              ...
              questionOptions: {
                ...
                concept: '159936AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
                conceptMappings: [
                  { type: 'SNOMED-CT', value: '43741000' },
                  { type: 'AMPATH', value: '2051' },
                ],
                answers: [
                  {
                    concept: '5622AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
    ...
    { label: 'Pre-test counseling', sections: [] },
    { label: 'TB / STI screening', sections: [] },
    { label: 'HIV testing', sections: [] },
    { label: 'Linkage to care', sections: [] },
    { label: 'Referrals', sections: [] },
  ],
