    ...
    <div className={styles.textContainer}>
      <FormGroup legendText={questions.label}>
        <RadioButtonGroup defaultSelected="default-selected" name="radio-button-group" valueSelected="default-selected">
          {radioContent.map(function(answer: OhriAnswerOptionType, qAns) {
            return <RadioButton id={answer.label} labelText={answer.label} value={answer.label} onChange={onChange} />;
          })}
        </RadioButtonGroup>
      </FormGroup>
    </div>
