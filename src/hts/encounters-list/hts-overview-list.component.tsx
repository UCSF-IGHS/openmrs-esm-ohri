...
interface HtsOverviewListProps { patientUuid: string }
...
const HtsOverviewList: React.FC<HtsOverviewListProps> = ({ patientUuid }) => {
    ...
    const headerTitle = "HTS Encounters"
        ...
        {isLoading ?
            ...
            :
                    tableRows.length > 0 ?
                        ...
                        <EmptyState displayText="HTS encounters" headerTitle={headerTitle} launchForm={launchVisitNoteForm} />
                }
