...
const TptEnrolmentList: React.FC<TptEnrolmentListProps> = ({ patientUuid }) => {
    ...
    () => [
      {
        ...
        getValue: (encounter) => {
          return getObsFromEncounter(encounter, obsConcepts.tptCaseEnrollmentDate, true);
        },
      },
      {
        key: 'tptTreatmentID',
  ...
  return (
    <EncounterList
      ...
      encounterType={encounterTypes.tptCaseEnrolment}
      formList={[{ name: formNames.TptOutcomeFormName }, { name: formNames.TptCaseEnrolmentFormName }]}
      columns={columns}
