...
const PostnatalList: React.FC<PostnatalListProps> = ({ patientUuid }) => {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <EmptyStateComingSoon displayText={t('postnatal', 'Postnatal')} headerTitle={headerTitle} />
      )}
    </>
  );
};

export default PostnatalList;
