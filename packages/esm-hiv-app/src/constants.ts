...
export const ServiceEnrolmentFormName = 'Service Enrolment Form';
...
export const priorityPopulationTypeConcept = '2bf14240-b2b2-42b2-8cf3-b5f8a0cb7764';
...
export const HIVEnrolmentFormName = '746737c0-4201-4d7f-b580-816e36dc425a';
...
// HTS HIV
export const HIVTestingFormName = 'HIV Testing';
export const HTSPreTestFormName = 'HTS Pre-Test Counselling';
...
//HIV Death
export const deathFormName = 'Death Form';
...
//Transfer Out
export const TransferOutFormName = 'Transfer Out Form';
...
//Intimate Partner
export const IntimatePartnerFormName = 'Intimate Partner Violence Form';
...
//Contact Tracing
export const ContactTracingFormName = 'Contact Tracing Form';
...
//Service Delivery
export const ServiceDeliveryFormName = 'Service Delivery Model Form';
...
//Peads Disclosure
export const DisclosureFormName = 'Age Appropriate Disclosure Form';
...
export const PartnerNotificationFormName = 'Partner Notification Form';
...
//Mental Health
export const MentalHealthFormName = 'Mental Health Assessment Form';
...
//CD4 Lab Results
export const CD4LabResultsFormName = 'CD4 Lab Result';
...
//Viral Load Results
export const ViralLoadRequestFormName = 'POC Viral load request';
...
//Express Visit
export const ExpressVisitFormName = 'POC Express Visit Form';
...
//HTS PreTest
export const PreTestConceptUUID = '13abe5c9-6de2-4970-b348-36d352ee8eeb';
export const PreTestApproachConceptUUID = '9641ead9-8821-4898-b633-a8e96c0933cf';
