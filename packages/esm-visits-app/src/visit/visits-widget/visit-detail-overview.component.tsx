...
import VisitActions from './visit-actions.component';
...
function VisitDetailOverviewComponent({ patientUuid }: VisitOverviewComponentProps) {
  ...
  const { currentVisit, visits, isError, isLoading, mutateVisits } = useVisits(patientUuid);
                ...
                <div className={styles.container}>
                  <div className={styles.header}>
                    <div className={styles.visitInfo}>
                      ...
                      {visits?.length && <VisitActions visit={currentVisit} />}
                    </div>
                  </div>
